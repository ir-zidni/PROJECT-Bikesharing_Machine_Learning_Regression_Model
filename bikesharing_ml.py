...
def main():
    ...
    hum = st.number_input('Insert normalize humidity value', value=None, max_value=1, placeholder = "Type a number...")
    ...
    temp = st.number_input('Insert normalize temperature value',value=None, max_value=1, placeholder = "Type a number...")
