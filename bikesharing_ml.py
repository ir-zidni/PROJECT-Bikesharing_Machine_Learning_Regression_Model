...
def main():
    ...
    hum = st.number_input('Insert normalize humidity value', min_value=0, max_value=1, step=float)
    ...
    temp = st.number_input('Insert normalize temperature value', min_value=0, max_value=1, step=float)
