...
def main():
    ...
    st.write('Weathersit Type:', '1: Clear, Few clouds, Partly cloudy, Partly cloudy', 
    ...
    temp = st.number_input('Insert normalize temperature value',min_value=0.0, max_value=1.0, placeholder = "Type a number...")
